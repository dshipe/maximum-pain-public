    ...
    [
      ...
      },
      {
        ...
        public void Base64()
        {
            ...
            OpenInNotepad(json);
            Assert.IsLessThan(json.Length, base64.Length);
        }
        ...
        public async Task SendTelegram()
        {
            ...
            var result = await SMSSvc.SendTelegram(msg);
            OpenInNotepad(result);
            Assert.AreNotEqual(0, result.Length);
        }
        ...
        {
            var midnight = Convert.ToDateTime("2025-11-28");
            var daily = await _homeContext.DailyScan(midnight);
            //var details = await ControllerSvc.Daily();
            Assert.AreNotEqual(0, daily.Count);
        }
        ...
        public async Task Import()
        {
            ...
            Assert.AreEqual(0, chains.Count);
        }
