    ...
    public class Functions
    {
        ...
        public void ConfigureServices(HostBuilderContext context, IServiceCollection serviceCollection)
        {
            ...
            */
            ...
            string AWSConnection = "Data Source=ec2-35-172-202-150.compute-1.amazonaws.com,1433;Initial Catalog=MaxPainAPI;User ID=SuperUser;Password=Database6#10oz;Trusted_Connection=False;MultipleActiveResultSets=true;Encrypt=False;";
            serviceCollection.AddDbContext<AwsContext>(options => options.UseSqlServer(AWSConnection));
            string HomeConnection = "Data Source=ec2-35-172-202-150.compute-1.amazonaws.com,1433;Initial Catalog=Fin;User ID=sa;Password=6#10oz;Trusted_Connection=False;Encrypt=False;";
