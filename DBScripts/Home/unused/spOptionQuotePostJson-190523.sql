...
BEGIN
	...
	*/
	...
	FROM OPENJSON(@json)
	  WITH (
		OptionTicker nvarchar(20) '$.OT'
		,LastPrice nvarchar(10) '$.LLP'
		,Bid nvarchar(10) '$.B'
		,Ask nvarchar(10) '$.A'
		,OpenInterest nvarchar(10) '$.OI'
		,Volume nvarchar(10) '$.V'
		,ImpliedVolatility nvarchar(20) '$.IV'
	) 
